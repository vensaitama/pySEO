...
data = meal["meals"]
print(len(data))
first_data = data[0]["strMeal"]
second_data = data[1]["strMeal"]
third_data = data[2]["strMeal"]
fourth_data = data[3]["strMeal"]

print(first_data, second_data, third_data, fourth_data, sep=("\n"))