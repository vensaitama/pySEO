...
# print(type(data))
# print(data.keys())
first_meal = data["meals"][0]["strMeal"]
second_meal = data["meals"][1]["strMeal"]
third_meal = data["meals"][2]["strMeal"]
fourth_meal = data["meals"][3]["strMeal"]
print(first_meal, second_meal, third_meal, fourth_meal, sep="\n")
